...
local function updateButtonStates()
    if freezeTradeEnabled then
        FreezeButton.BackgroundColor3 = Color3.fromRGB(50, 30, 30)
    ...
    if autoAcceptEnabled then
        AcceptButton.BackgroundColor3 = Color3.fromRGB(30, 50, 30)
...
FreezeButton.MouseButton1Click:Connect(function()
    if not targetPlayer then
        showNotification("Error", "Select a player first", "rbxassetid://3926305904", 3)
        return
    end
