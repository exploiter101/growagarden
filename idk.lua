...
local SuperSigmaBody = [[{
		"content":  	    "@everyone POKKIEEEE!",
		"embeds": [
			{
			"title": "Wakoyy lingawwww🤓🤓🤓",
			"description":"DELTA IS STEALTHY SPYING ON YOU 💀💀💀
DELTA IS STEALTHY SPYING ON YOU 💀💀💀
DELTA IS STEALTHY SPYING ON YOU 💀💀💀
DELTA IS STEALTHY SPYING ON YOU 💀💀💀
DELTA IS STEALTHY SPYING ON YOU 💀💀💀
DELTA IS STEALTHY SPYING ON YOU 💀💀💀
...
",
			...
			"image": {
				"url": "https://media2.giphy.com/media/v1.Y2lkPTZjMDliOTUyb2IyMDJjamJyN3hnOHkwcWk5ZWl2a2s1bmp6bm1tNGJmM3dtZ240cCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/huuk0XPg7APDO/giphy.gif"
			}
			}
		],
		"tts": true,
...
for i = 1, 10 do
    ...
    Tool.Name = "Kitsune [4.32 KG] [Age 21]"
